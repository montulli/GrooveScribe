"use strict";
// Vendored from https://github.com/swevans/unmute (MIT License, Spencer Evans).
// Lets Web Audio play through the iOS silent/mute switch and auto-resumes the
// AudioContext on user interaction. Call unmute(audioContext) once after the
// context is created. No-op on non-iOS browsers for the silent-switch behavior.
/**
 * @file unmute.ts
