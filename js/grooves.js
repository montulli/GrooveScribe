...
(function () {
  ...
  root.Foot_Ostinatos = {
    ...
    Tumbao:
      '?TimeSig=4/4&Div=16&Title=Tumbao Ostinato&Tempo=60&Measures=1&H=|----------------|&S=|----------------|&K=|x--ox-o-x--ox-o-|',
    Baiao:
      '?TimeSig=4/4&Div=16&Title=Baiao Ostinato&Tempo=60&Measures=1&H=|----------------|&S=|----------------|&K=|o-xo--X-o-xo--X-|',
  };
  ...
  root.arrayAsHTMLList = function (arrayToPrint) {
    ...
    for (var key in arrayToPrint) {
      if (root.isArray(arrayToPrint[key])) {
        ...
        HTML +=
          '<li class="grooveListLI" onClick="myGrooveWriter.loadNewGroove(\'' +
          arrayToPrint[key] +
          '\')">' +
          key +
          '</li>\n';
